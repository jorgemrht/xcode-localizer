...
struct ColorDynamicFileGeneratorTest {
    ...
    func includesUIKitDynamicColorSupport() {
        ...
        // UIKit any-dark color initializer
        ...
        // UIKit any-light-dark color initializer
    ...
    func includesAppKitDynamicColorSupport() {
        ...
        // AppKit any-dark color initializer
        ...
        // AppKit any-light-dark color initializer
        #expect(result.contains("init(any: NSColor, light: NSColor, dark: NSColor)"))
        
        // AppKit light-dark color initializer
    ...
    // MARK: - Platform-Specific Compilation Tests
